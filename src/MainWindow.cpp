    ...
    deviceManager(new DeviceManager(this))
{
    ...
    ui->textEditLog->append("<span style='color:#4CAF50;'>Система настроена для обнаружения сканирования портов и других атак как с локального компьютера, так и с других компьютеров в сети</span>");
}
